...
local function isa(cl, obj)
	...
	-- Don't operate on the class itself, operate on the metatable.
	-- This allows the class the ability to lose the 'isa' and 'isaSet' fields.
	-- It also allows isa(class, subclass) to work.
	obj = getmetatable(obj) or obj
